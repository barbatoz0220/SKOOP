...
public class TileMapSpawn extends TileMap{
    ...
    public TileMapSpawn(String data, Sprite sprite, int width, int height, int tileWidth, int tileHeight, int tileColumns) {
        Block tempBlock;
